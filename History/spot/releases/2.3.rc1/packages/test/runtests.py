...
global acro_bin_dir         # path to acro's python bin directory
global acro_site_packages   # path to acro site packages
...
def setBuildDirectoryPaths():
  ...
  acro_py_dir=top_dir+os.sep+"tpl"+os.sep+"acro"+os.sep+"python"
...
if len(sys.argv) < 2:
  ...
  for nm in testNames:
    ...
    i = i + 1
  print
  choice=raw_input("Enter a comma separated list of numbers or \"all\": ")
