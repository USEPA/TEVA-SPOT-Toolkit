...
/**
 * Read a file containing probabilities of events for different scenarios.
 * Format:
 *    <node-id> <probability>
 */
 ...
 *    <sc> <probability>
 */
inline void read_sc_probabilities(std::istream& istr,
 ...
 * Read an impact file.
 */
// TNT:  Changed the arrival_sequences parameter to a pointer so it can be passed
// in as NULL in order to indicate that it is not needed
