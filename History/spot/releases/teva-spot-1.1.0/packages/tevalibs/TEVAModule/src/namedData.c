...
static void x_initDataTypes(JNIEnv *env)
{
	jclass dataClass = (*env)->FindClass(env,"anl/teva/analysis/module/Data");
//	x_DataTypes = calloc(NUM_TYPES,sizeof(jobject));
	if(ANL_UTIL_CheckForException(env, "unable to find class anl.teva.analysis.module.Data\n"))
		return;

	x_DataTypes[INT_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"INT_TYPE","Lanl/teva/analysis/module/DataType;"));
	x_DataTypes[INT_ARRAY_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"INT_ARRAY_TYPE","Lanl/teva/analysis/module/DataType;"));
	x_DataTypes[INT_ARRAY_2D_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"INT_ARRAY_2D_TYPE","Lanl/teva/analysis/module/DataType;"));

	x_DataTypes[FLOAT_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"FLOAT_TYPE","Lanl/teva/analysis/module/DataType;"));
	x_DataTypes[FLOAT_ARRAY_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"FLOAT_ARRAY_TYPE","Lanl/teva/analysis/module/DataType;"));
	x_DataTypes[FLOAT_ARRAY_2D_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"FLOAT_ARRAY_2D_TYPE","Lanl/teva/analysis/module/DataType;"));
	
	x_DataTypes[DOUBLE_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"DOUBLE_TYPE","Lanl/teva/analysis/module/DataType;"));
	x_DataTypes[DOUBLE_ARRAY_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"DOUBLE_ARRAY_TYPE","Lanl/teva/analysis/module/DataType;"));
	x_DataTypes[DOUBLE_ARRAY_2D_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"DOUBLE_ARRAY_2D_TYPE","Lanl/teva/analysis/module/DataType;"));
	
	x_DataTypes[BYTE_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"BYTE_TYPE","Lanl/teva/analysis/module/DataType;"));
	x_DataTypes[BYTE_ARRAY_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"BYTE_ARRAY_TYPE","Lanl/teva/analysis/module/DataType;"));
	x_DataTypes[BYTE_ARRAY_2D_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"BYTE_ARRAY_2D_TYPE","Lanl/teva/analysis/module/DataType;"));
	
	x_DataTypes[STRING_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"STRING_TYPE","Lanl/teva/analysis/module/DataType;"));
	x_DataTypes[STRING_ARRAY_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"STRING_ARRAY_TYPE","Lanl/teva/analysis/module/DataType;"));

	x_DataTypes[NAMED_DATA_TYPE] = (*env)->NewGlobalRef(env,ANL_UTIL_getObjectStaticVar(env,dataClass,"NAMED_DATA_TYPE","Lanl/teva/analysis/module/DataType;"));
}
static NamedDataPtr x_initNamedData(JNIEnv *env, int isServer)
{
	jclass tclass;
	...
	if(isServer) {
		tclass = (*env)->FindClass(env,"anl/teva/analysis/module/NamedDataServer");
		if(ANL_UTIL_CheckForException(env, "unable to find class anl.teva.analysis.module.NamedDataServer\n"))
			return NULL;
	} else {
		tclass = (*env)->FindClass(env,"anl/teva/analysis/module/NamedData");
		if(ANL_UTIL_CheckForException(env, "unable to find class anl.teva.analysis.module.NamedData\n"))
			return NULL;
	}
	...
	p->ndAddVariableMethod = (*env)->GetMethodID(env,p->namedDataClass,"addVariable","(Ljava/lang/String;Lanl/teva/analysis/module/DataType;)V");
	if(ANL_UTIL_CheckForException(env, "unable to find void addVariable method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;

	// get methods
	p->ndGetIntMethod = (*env)->GetMethodID(env,p->namedDataClass,"getInt","(Ljava/lang/String;)I");
	if(ANL_UTIL_CheckForException(env, "unable to find int getInt(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	p->ndGetIntArrayMethod = (*env)->GetMethodID(env,p->namedDataClass,"getIntArray","(Ljava/lang/String;)[I");
	if(ANL_UTIL_CheckForException(env, "unable to find int[] getIntArray(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	p->ndGetIntArrayAtIndexMethod = (*env)->GetMethodID(env,p->namedDataClass,"getIntArray","(Ljava/lang/String;I)[I");
	if(ANL_UTIL_CheckForException(env, "unable to find int[] getIntArray(String,int) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;

	p->ndGetByteMethod = (*env)->GetMethodID(env,p->namedDataClass,"getByte","(Ljava/lang/String;)B");
	if(ANL_UTIL_CheckForException(env, "unable to find byte getByte(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	p->ndGetByteArrayMethod = (*env)->GetMethodID(env,p->namedDataClass,"getByteArray","(Ljava/lang/String;)[B");
	if(ANL_UTIL_CheckForException(env, "unable to find byte[] getByteArray(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	p->ndGetByteArrayAtIndexMethod = (*env)->GetMethodID(env,p->namedDataClass,"getByteArray","(Ljava/lang/String;I)[B");
	if(ANL_UTIL_CheckForException(env, "unable to find byte[] getByteArray(String,int) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;

	p->ndGetFloatMethod = (*env)->GetMethodID(env,p->namedDataClass,"getFloat","(Ljava/lang/String;)F");
	if(ANL_UTIL_CheckForException(env, "unable to find float getFloat(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	p->ndGetFloatArrayMethod = (*env)->GetMethodID(env,p->namedDataClass,"getFloatArray","(Ljava/lang/String;)[F");
	if(ANL_UTIL_CheckForException(env, "unable to find float[] getFloatArray(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	p->ndGetFloatArrayAtIndexMethod = (*env)->GetMethodID(env,p->namedDataClass,"getFloatArray","(Ljava/lang/String;I)[F");
	if(ANL_UTIL_CheckForException(env, "unable to find float[] getFloatArray(String,int) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;

	p->ndGetDoubleMethod = (*env)->GetMethodID(env,p->namedDataClass,"getDouble","(Ljava/lang/String;)D");
	if(ANL_UTIL_CheckForException(env, "unable to find double getDouble(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	p->ndGetDoubleArrayMethod = (*env)->GetMethodID(env,p->namedDataClass,"getDoubleArray","(Ljava/lang/String;)[D");
	if(ANL_UTIL_CheckForException(env, "unable to find double[] getDoubleArray(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	p->ndGetDoubleArrayAtIndexMethod = (*env)->GetMethodID(env,p->namedDataClass,"getDoubleArray","(Ljava/lang/String;I)[D");
	if(ANL_UTIL_CheckForException(env, "unable to find double[] getDoubleArray(String,int) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;

	p->ndGetStringMethod = (*env)->GetMethodID(env,p->namedDataClass,"getString","(Ljava/lang/String;)Ljava/lang/String;");
	if(ANL_UTIL_CheckForException(env, "unable to find String getString(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	p->ndGetStringArrayMethod = (*env)->GetMethodID(env,p->namedDataClass,"getStringArray","(Ljava/lang/String;)[Ljava/lang/String;");
	if(ANL_UTIL_CheckForException(env, "unable to find String[] getStringArray(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;

	p->ndGetNamedDataMethod = (*env)->GetMethodID(env,p->namedDataClass,"getNamedData","(Ljava/lang/String;)Lanl/teva/analysis/module/NamedData;");
	if(ANL_UTIL_CheckForException(env, "unable to find NamedData getNamedData(String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;

	// set methods
	p->ndSetIntMethod = (*env)->GetMethodID(env,p->namedDataClass,"setData","(Ljava/lang/String;I)V");
	if(ANL_UTIL_CheckForException(env, "unable to find void setData(String,int) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	...
	if(ANL_UTIL_CheckForException(env, "unable to find void setData(String,byte) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	...
	if(ANL_UTIL_CheckForException(env, "unable to find void setData(String,float) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	...
	if(ANL_UTIL_CheckForException(env, "unable to find void setData(String,double) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	...
	if(ANL_UTIL_CheckForException(env, "unable to find void setData(String,String) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
	p->ndSetStringArrayMethod = (*env)->GetMethodID(env,p->namedDataClass,"setData","(Ljava/lang/String;[Ljava/lang/String;)V");
	if(ANL_UTIL_CheckForException(env, "unable to find void setData(String,double[]) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;

	p->ndSetNamedDataMethod = (*env)->GetMethodID(env,p->namedDataClass,"setData","(Ljava/lang/String;Lanl/teva/analysis/module/NamedData;)V");
	if(ANL_UTIL_CheckForException(env, "unable to find void setData(String,NamedData) method in class anl.teva.analysis.module.NamedData\n"))
		return NULL;
