 ...
 * \if GeneratingHTML [\ref Knu "Knu"]. \endif
...
/// Return the index of the minimal element of the array using a comparison class.
...
template <class RNGT>
size_type argmedian(double* x, size_type n, int* ws, RNGT* rng)
{
...
/// Return the index of the median element of the array
inline size_type argmedian(double* x, size_type n, int* ws)
{
