...
#if !defined(SOLARIS) && !defined(_MSC_VER)
...
/// Output to an \c ostream
template <class T>
inline ostream& operator<<(ostream& output, const utilib::SparseMatrix<T>& array)
{ array.write(output); return(output); }

/// Read from an \c istream
template <class T>
inline istream& operator>>(istream& input, utilib::SparseMatrix<T>& array)
{ array.read(input); return(input); }


/// Stream operator for packing
template <class T>
inline utilib::PackBuffer& operator<<(utilib::PackBuffer& output, const utilib::SparseMatrix<T
>& array)
{ array.write(output); return(output); }

/// Stream operator for unpacking
template <class T>
inline utilib::UnPackBuffer& operator>>(utilib::UnPackBuffer& input, utilib::SparseMatrix<T>&
array)
{ array.read(input); return(input); }
