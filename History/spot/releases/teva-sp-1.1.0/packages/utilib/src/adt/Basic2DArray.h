 ...
 * \file Basic2DArray.h
 *
 * \depricated definition of the utilib::Basic2DArray class
 */
...
public:
  ...
  T* operator[](const unsigned int i);
	/// Returns the i-th row of the 2D array
  T* operator[](const unsigned long int i) const;
	/// Returns the i-th row of the 2D array
  T* operator[](const unsigned long int i);
	/// Returns the i-th row of the 2D array
...
template <class T>
inline T* Basic2DArray<T>::operator[](const unsigned int idx)
{
#if (TwoDArraySanityChecking==1)
if (idx >= a->Nrows)
   EXCEPTION_MNGR(runtime_error, "Basic2DArray<T>::operator[] : iterator out of range. idx=" << idx << " len=" << a->Nrows)
...
template <class T>
inline T* Basic2DArray<T>::operator[](const unsigned int idx) const
{
#if (TwoDArraySanityChecking==1)
if (idx >= a->Nrows)
   EXCEPTION_MNGR(runtime_error, "Basic2DArray<T>::operator[] : iterator out of range. idx=" << idx << " len=" << a->Nrows)
...
template <class T>
inline T* Basic2DArray<T>::operator[](const unsigned long int idx)
{
#if (TwoDArraySanityChecking==1)
if (idx >= a->Nrows)
   EXCEPTION_MNGR(runtime_error, "Basic2DArray<T>::operator[] : iterator out of range. idx=" << idx << " len=" << a->Nrows)
...
template <class T>
inline T* Basic2DArray<T>::operator[](const unsigned long int idx) const
{
#if (TwoDArraySanityChecking==1)
if (idx >= a->Nrows)
   EXCEPTION_MNGR(runtime_error, "Basic2DArray<T>::operator[] : iterator out of range. idx=" << idx << " len=" << a->Nrows)
...
if ((array.nrows() != x.nrows()) || (array.ncols() != x.ncols()))
   EXCEPTION_MNGR(runtime_error, "Basic2DArray<T>::operator<< : Unequal vector matrices " << x.nrows() << "x" << x.ncols() << " and " << array.nrows() << "x" << array.ncols())
...
{
if (x.ncols() != val.size())
   EXCEPTION_MNGR(runtime_error, "operator<< : Array length does not equal the 2DArray columns " << val.size() << " and " << x.ncols())
