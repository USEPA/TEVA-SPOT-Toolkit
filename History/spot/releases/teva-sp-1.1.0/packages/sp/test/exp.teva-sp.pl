...
elsif (-e $pwd . "/../../utilib/src/doe/TestLib.pm") {
   unshift @INC, $pwd . "/../../utilib/src/doe";
   $ENV{'PATH'} = $ENV{'PATH'} . ":.:" . $pwd . "/../../utilib/src/doe";
}
require TestLib;
...
if (! @ARGV) {
   ...
   print "options:\n";
   print "\n";
   print "   --tso\t\tRun threat_sim to create .tso.\n";
   print "\n";
...
if (($sp == 1) || ($sp_simple == 1)) {
   ...
   #
   if ($sp == 1) {
      $cmdline = "../bin/sp --path=../bin --path=../mod --print-log $auxoptions";
   } else {
      ...
      $cmdline = "../bin/sp --path=../bin --path=../mod --print-log --objective=$objective $auxoptions --seed=\$seed";
   }
   ...
   # Setup command line
   #
   #print "teva-sp.exp.pl: command is threat_sim: ";
   #print "threat_sim options: ";
   #print $auxoptions;
   $cmdline = "../../tevalibs/threat_sim $auxoptions";
