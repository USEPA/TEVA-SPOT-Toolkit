...
public:
   ...
   virtual void finalizeForScenario(int scenarioIndex, PSource sources, int numSources)
   {
      outputScenarioImpactData(scenarioIndex, sources, numSources);
   ...
   virtual void outputScenarioImpactData(int scenarioIndex, PSource sources, int numSources)
   {
      if (myScenarioIDFile)
      {
         //
