...
extern "C" {
void run_flushsim(int tsofileversion, const char* tsgfname, const char* tsifname, const char* tsofname, const char* epanetinpfname, const char* epanetoutfname, const char* decfname);
};
...
const char *tsg=NULL, *tsi=NULL, *tso=NULL, *dvf=NULL;
if (tsifname != "")
   tsi=tsifname.c_str();
if (tsgfname != "")
   tsg=tsgfname.c_str();
...
run_flushsim(tsofileversion, tsg, tsi, tso, epanetinpfname.c_str(), epanetoutfname.c_str(), dvf);
