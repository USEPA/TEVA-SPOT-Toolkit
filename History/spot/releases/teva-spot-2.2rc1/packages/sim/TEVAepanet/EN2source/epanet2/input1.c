...
*/
{
   ...
   {
      strcpy(Field[(size_t)DEMAND].Units,RptFlowUnitsTxt[(size_t)Flowflag]);
      ...
      strcpy(Field[FLOW].Units,RptFlowUnitsTxt[(size_t)Flowflag]);
   ...
   {
      strcpy(Field[DEMAND].Units,RptFlowUnitsTxt[(size_t)Flowflag]);
