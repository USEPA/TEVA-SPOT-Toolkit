...
\n\
  ...
  utilib::BasicArray<utilib::BasicArray<std::map<int,double> > > delayed_impacts(files.size());
  ...
  utilib::BasicArray<utilib::BasicArray<std::map<int,double> > >::iterator dicurr = delayed_impacts.begin();
