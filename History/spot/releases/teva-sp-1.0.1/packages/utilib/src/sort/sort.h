...
{ order(ndx,v,std::less<int>()); }

/// Order an array using a stable sort.
template <class T>
void stable_order(std::vector<int>& ndx, const std::vector<T>& v)
{ stable_order(ndx,v,std::less<int>()); }



/// Rank an array
template <class T>
inline void rank(BasicArray<int>& rvec, BasicArray<T>& v)
{
BasicArray<int> ovec;
order(ovec, v);
rvec.resize(v.size());
...
template <class T>
inline void stable_rank(BasicArray<int>& rvec, BasicArray<T>& v)
{
BasicArray<int> ovec;
stable_order(ovec, v);
rvec.resize(v.size());
...
/// Rank an array
template <class T, class CompareT>
inline void rank(BasicArray<int>& rvec, BasicArray<T>& v, CompareT compare)
{
BasicArray<int> ovec;
...
/// Rank an array
template <class T>
inline void rank(std::vector<int>& rvec, std::vector<T>& v)
{
std::vector<int> ovec;
order(ovec, v);
rvec.resize(v.size());
...
/// Rank an array using a stable sort.
template <class T>
inline void stable_rank(std::vector<int>& rvec, std::vector<T>& v)
{
std::vector<int> ovec;
stable_order(ovec, v);
rvec.resize(v.size());
