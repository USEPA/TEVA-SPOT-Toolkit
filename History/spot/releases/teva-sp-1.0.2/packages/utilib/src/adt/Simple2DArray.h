 ...
 *
 * \depricated definition of utilib::Simple2DArray class
 */
...
template <class T>
inline UTILIB_API ostream& operator<<(ostream& output, const utilib::Simple2DArray<T>& array)
{ array.write(output); return(output); }
 
/// Stream operator for reading
template <class T>
inline UTILIB_API istream& operator>>(istream& input, utilib::Simple2DArray<T>& array)
{ array.read(input); return(input); }
 
/// Stream operator for packing
template <class T>
inline UTILIB_API utilib::PackBuffer& operator<<(utilib::PackBuffer& output, const utilib::Simple2DArray<T>& array)
{ array.write(output); return(output); }
 
/// Stream operator for unpacking
template <class T>
inline UTILIB_API utilib::UnPackBuffer& operator>>(utilib::UnPackBuffer& input, utilib::Simple2DArray<T>& array)
{ array.read(input); return(input); }
