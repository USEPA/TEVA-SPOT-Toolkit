 ...
 */
class BitArray : public BitArrayBase<0,long long,BitArray>
{
public:

  typedef BitArrayBase<0,long long,BitArray> base_t;
  #if !defined(SOLARIS)
  using base_t::Len;
  #endif
...
if (val == 0)
   ...
   EXCEPTION_MNGR(runtime_error, "operator<< : value " << val << " out of range.")
return x;
}
