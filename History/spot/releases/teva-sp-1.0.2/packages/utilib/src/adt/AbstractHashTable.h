...
public:
   ...
   * otherwise.
   */
  virtual void remove(const KEY& key, bool& status)
	{
	iterator tmp = find(key);
	if (tmp != end()) extract(&(*tmp),status);
	else     status = false;
	}
   ...
   * otherwise.
   */
  virtual void remove(iterator& item, bool& status)
	{
        if (item == end())
           status = false;
        else
   ...
   * otherwise.
   */
  virtual void remove(iterator& item, KEY& key, bool& status)
        {
        if (item == end())
           status = false;
        else {
...
template <class T, class KEY, class InfoT>
void AbstractHashTable<T,KEY,InfoT>::extract(T* item, bool& status)
{
hash_element curr;
status = false;
...
template <class T, class KEY, class InfoT>
void AbstractHashTable<T,KEY,InfoT>::statistics(ostream& os)
{
...
template <class T, class KEY, class InfoT>
void AbstractHashTable<T,KEY,InfoT>::resize(const int newsize)
{
int tmp = newsize;
bool flag=true;
...
template <class T, class KEY, class InfoT>
void AbstractHashTable<T,KEY,InfoT>::write(PackBuffer& os) const
{
os << data.size();

typename LinkedList<T*>::const_iterator curr = data.begin();
typename LinkedList<T*>::const_iterator end  = data.end();
while (curr != end) {
  (*curr)->write(os);
  curr++;
  }
...
template <class T, class KEY, class InfoT>
void AbstractHashTable<T,KEY,InfoT>::read(UnPackBuffer& is)
{
size_type num;
is >> num;
...
template <class T, class KEY, class InfoT>
void AbstractHashTable<T,KEY,InfoT>::write(ostream& os) const
{
os << data.size() << endl;
...
//
template <class T, class KEY, class InfoT>
void AbstractHashTable<T,KEY,InfoT>::read(istream& is)
{
clear();
size_type Size;
is >> Size;
...
/// Out-stream operator for printing the contents of a AbstractHashTable
template <class T, class KEY, class InfoT>
inline ostream& operator<<(ostream& output, const utilib::AbstractHashTable<T,KEY,InfoT>& 
					table)
{ table.write(output); return(output); }


/// In-stream operator for reading the contents of a AbstractHashTable
template <class T, class KEY, class InfoT>
inline istream& operator>>(istream& input, utilib::AbstractHashTable<T,KEY,InfoT>& table)
