...
//
///
inline std::ostream& operator<< (std::ostream& ostr, const utilib::Parameter& item)
...
//
//
inline std::istream& operator>> (std::istream& istr, utilib::Parameter& item)
...
//
//
inline utilib::PackBuffer& operator<< (utilib::PackBuffer& ostr, const utilib::Parameter& item)
{ item.write(ostr); return ostr; }
...
//
//
inline utilib::UnPackBuffer& operator>> (utilib::UnPackBuffer& istr, utilib::Parameter& item)
{ item.read(istr); return istr; }
