...
#else
int method = CPXgetmethod(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(), getMutableLpPtr() );
...
int stat = 
#endif
CPXgetstat( const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(), getMutableLpPtr() );
#if (CPX_VERSION >= 800)
return false;
#else
int method = CPXgetmethod(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(), getMutableLpPtr() );
...
{
double ans;
CPXgetlb(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),&ans,whichVariable,whichVariable);
return ans;
}
...
{
double ans;
CPXgetub(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),&ans,whichVariable,whichVariable);
return ans;
}
...
{
char sense;
CPXgetsense(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),&sense,whichVariable,whichVariable);
double rhs;
CPXgetrhs(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),&rhs,whichVariable,whichVariable);
double range;
CPXgetrngval(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),&range,whichVariable,whichVariable);
double lower, upper;
...
{
double rhs;
CPXgetrhs(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),&rhs,whichConstraint,whichConstraint);
return rhs;
}
...
{
char csense;
CPXgetsense( const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(), &csense, whichConstraint, whichConstraint);
...
{
double ans;
int err = CPXgetobj(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),&ans,whichVariable,whichVariable);
...
{
double ans = 0.0;
int probType = CPXgetprobtype(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr());
#if (CPX_VERSION >= 800)
if ( probType == CPXPROB_MILP ) {
#else
if ( probType == CPXPROB_MIP ) {
#endif
   int err = CPXgetmipx( const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(), &ans, whichCol, whichCol);
   ...
   int err = CPXgetx( const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(), &ans, whichCol, whichCol );
...
{
double ans;
int err = CPXgetpi(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),&ans,whichRow,whichRow);
if (err == CPXERR_NO_SOLN)
   ans = 0.0;
else
...
{
double ans;
int err = CPXgetdj(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),&ans,whichCol,whichCol);
if (err == CPXERR_NO_SOLN)
   ans = 0.0;
else
...
int tmp = CPXgetbase(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),(int*)(tempBasis.data()),(int*)(&tempBasis[numCols]));
if (tmp)
...
int tmp = CPXgetbase(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),
...
status = CPXcopybase(const_cast<PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>*>(this)->OsiCpxSolverInterface::getEnvironmentPtr(),getMutableLpPtr(),(int*)(tempBasis.data()),
...
void PicoLPSubclass<OsiCpxSolverInterface,PicoLPCutMngmnt>::setColUpper(double* upperBounds, int* indexList, int len)
{
  ...
  int err = CPXchgbds( getEnvironmentPtr(), getMutableLpPtr(), len, indexList, &c, upperBounds);
...
{
  char c = 'L';
  int err = CPXchgbds( getEnvironmentPtr(), getMutableLpPtr(), len, indexList, &c, lowerBounds);
...
if (format == mps_format)
  ...
  writeStatus = CPXwriteprob(getEnvironmentPtr(), getMutableLpPtr(), filename, "MPS");
  if (writeStatus)
...
if (format == lp_format)
  {
  writeStatus = CPXwriteprob(getEnvironmentPtr(), getMutableLpPtr(), filename, "LP");
  if (status)
    ucout << "Error writing lp to file\n";
  return;
  }
...
{
    int stat = CPXgetstat( getEnvironmentPtr(), getMutableLpPtr() );
...
{
    int stat = CPXchgcoef(getEnvironmentPtr(), getMutableLpPtr(), row, col, newValue);
