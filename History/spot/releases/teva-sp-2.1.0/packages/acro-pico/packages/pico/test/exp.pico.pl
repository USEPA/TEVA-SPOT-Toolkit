...
if (! @ARGV) {
   print "\n";
   print "exp.pico.pl - PICO experiment driver (for LP/MILP problems)\n";
   print "\n";
   print "usage:\n";
   print "\n";
   print "   exp.pico.pl [options] <expname> <testname> <factor-id> <factor-value> [...]\n";
   print "\n";
   print "options:\n";
   print "\n";
   print "   --lp\t\t\tSolve the LP relaxation if the problem is a MIP.\n";
   print "\n";
   print "   --ampl\t\tUse the AMPL solver interface to setup this problem.\n";
   print "         \t\tThe default is to use the MathProg reader which is\n";
   print "         \t\tintegrated into PICO.\n";
   print "\n";
...
if ($ampl eq "false") {
   #
   # Setup PICO command line
   #
   $cmdline = "$solverdir/PICOtest ";
   ...
   #
   $cmdline = "ampl ${expname}-${testname}.mod";
   ...
   print OUTPUT "option solver \"$solverdir/PICOtest\";\n";
   print OUTPUT "option PICO_options (\" $auxoptions \");\n";
   print OUTPUT "solve;\n";
   close(OUTPUT);
}
if ($debug == 1) {
