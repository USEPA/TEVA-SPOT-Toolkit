...
The latest version of PEBBL can also be acquired from
from http://software/sandia.gov/Acro.  For example, compressed tarballs
for the version of the day (VOTD) can be downloaded and extracted with the 
following:
\begin{verbatim}
