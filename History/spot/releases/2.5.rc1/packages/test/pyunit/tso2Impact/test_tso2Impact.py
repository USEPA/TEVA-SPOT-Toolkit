...
class Test(pyutilib.th.TestCase):
    ...
    def execute_test(self, network, frequency, impact, name):
        ...
        self.assertFileEqualsBaseline(currdir+file,tsodir+file)
    ...
    def test_largeQuality1(self):
        ...
        self.assertFileEqualsBaseline(currdir+"largeQuality_mc.out",tsodir+"largeQuality_mc.impact")
    ...
    def test_largeQuality2(self):
        ...
        self.assertFileEqualsBaseline(currdir+"largeQuality_ec.out",tsodir+"largeQuality_ec.impact")
    ...
    def test_multi_quality1(self):
        ...
        self.assertFileEqualsBaseline(currdir+"multi_quality_mc.impact",tsodir+"multi_quality_mc.impact")
    ...
    def test_multi_quality2(self):
        ...
        print "Running "+cmd
        pyutilib.subprocess.run(cmd, "multi_quality.out", cwd=currdir)
        self.assertFileEqualsBaseline(currdir+"multi_quality_pd.impact",tsodir+"multi_quality_pd.impact")
        os.remove(currdir+"multi_quality.out")
    ...
    def test_responseTime1(self):
        ...
        self.assertFileEqualsBaseline(currdir+"responseTime1_mc.impact",tsodir+"responseTime1_mc.impact")
