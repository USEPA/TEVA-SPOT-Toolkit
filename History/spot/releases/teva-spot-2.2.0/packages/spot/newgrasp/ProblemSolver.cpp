...
void ProblemSolver::runProcess() {
  ...
  if (inputMode==2)
    mySideIns = new SideConstraintInstance(instance, initialSolution, statistic, facilityLocationConstraints, gamma, sideConstraintStatistics, sideConstraintInstances, sideConstraintSolutions, sideConstraintUpperBounds); else if (inputMode==3)
