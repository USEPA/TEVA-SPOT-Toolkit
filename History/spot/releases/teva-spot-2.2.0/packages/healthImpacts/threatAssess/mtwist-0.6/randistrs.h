 ...
 *
 * $Log$
 * Revision 1.1  2007/07/02 16:09:39  taxon
 * Initial version with new ingestion timing modes and volume model.
 * Many internal data structures were modified to allow these new features.
 *
