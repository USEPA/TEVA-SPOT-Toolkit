...
\n\
   <impact-file>\n\
    ...
    if (strncmp(argv[ndx],"--attack-probabilities=",23) == 0) {
    ...
    // 
    // stores <witness-index,detection-time> for each attack scenario, sorted in order 
