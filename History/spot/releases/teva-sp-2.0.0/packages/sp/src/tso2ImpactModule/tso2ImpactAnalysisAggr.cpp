...
static std::string tsoFileOrDirectoryName;  // not used
...
static std::string epanetInputFilename;  // not used
static bool pkSelected=false;
static bool peSelected=false;
static std::string taiInputFilename;  // not used
static std::string tsoPattern;  // not used
				   ...
				   NamedDataRef *simResultsRef)
{
	...
	PLinkInfo dummy=NULL;	// no link info in simResultsRef yet
        initTso2ImpactAfterTsoRead(
                ...
                outputFilePrefix,  // not used
                tsoFileOrDirectoryName,  // not used
                detectionDelay,
                minQuality,
                mcSelected,
                vcSelected,
                ...
                tdSelected,
                ecSelected,
                epanetInputFilename,  // not used
                pkSelected,
                peSelected,
                taiInputFilename,  // not used
		x_mem,
                tsoPattern,  // not used
                sensorInputFilename,
                sensorLocations,
