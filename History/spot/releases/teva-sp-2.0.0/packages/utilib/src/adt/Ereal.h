...
#include <stdexcept>
#else
#error "Modify this file to work if we don't have exceptions"
#endif
...
/*
** TODO: What do we need to test for here?
*/
template <class Type>
#if defined(RS6K)
...
public:
   ...
   */
/*
** TODO: What is the issue we need to check for here?  Is
...
/*
** TODO: Write a configure time test for this, or find one
** in macro archive.
*/
#ifndef DARWIN 
...
long int lround(Ereal<Type>& num)
{
  if ( finite(num) ) {
    ...
    if (num == Ereal<Type>::negative_infinity)
      ...
      EXCEPTION_MNGR(std::invalid_argument, "Eread::lround: Attempt to round an indeterminate value to an integer")
    else if (num == Ereal<Type>::NaN)
      EXCEPTION_MNGR(std::invalid_argument, "Eread::lround: Attempt to round NaN to an integer.")
    else
      EXCEPTION_MNGR(std::runtime_error, "Eread::lround: Invalid internal state detected:" << num)
  }
