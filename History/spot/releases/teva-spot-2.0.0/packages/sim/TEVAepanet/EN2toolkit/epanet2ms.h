...
EXTERN int   CALLTYPE ENepanet(char *, char *, char *, void (*) ());
...
EXTERN int	 CALLTYPE ENMSgetspeciesindex(char *, int *);
EXTERN int   CALLTYPE ENMSgetspeciesid(int, char *);
EXTERN int   CALLTYPE ENMSgetspeciestype(int, int *);
EXTERN int   CALLTYPE ENMSgetparameterindex(char *, int *);
EXTERN int   CALLTYPE ENMSgetparameterid(int, char *);
EXTERN int   CALLTYPE ENMSgetnodequality(int, int, int, float *);
EXTERN int   CALLTYPE ENMSsetnodequality(int, int, int, float);
EXTERN int   CALLTYPE ENMSgetlinkquality(int, int, float *);
EXTERN int   CALLTYPE ENMSgetparametervalue(int, int, int, float *);
EXTERN int   CALLTYPE ENMSsetparametervalue(int, int, int, float);
EXTERN int   CALLTYPE ENMSgetmassreact(int, float *);
