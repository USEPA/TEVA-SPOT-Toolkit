...
#else
options.add_usage("tso2Impact [options] <output-prefix> <tso-directory-or-files>");
options.description = "An application that reads a TSO file and creates one or more impact files that are used to formulate sensor placement problems.";
#endif
...
options.add('r',"responseTime",detectionDelay, "This parameter indicates the number of minutes that are needed to respond to the detection of a continant.  As the response time increases, the impact increases because the contaminant affects the network for a greater length of time. Unit: minutes.");
...
options.add("mc",mcSelected,"If this flag is specified, an impact file will be generated for the 'mass consumed' measure.");
options.add("dmc",dmcSelected,"If this flag is specified, an impact file will be generated for the 'detected mass consumed' measure.");

options.add("vc",vcSelected,"If this flag is specified, an impact file will be generated for the 'volume consumed' measure.");
options.add("dvc",dvcSelected,"If this flag is specified, an impact file will be generated for the 'detected volume consumed' measure.");

options.add("td",tdSelected,"If this flag is specified, an impact file will be generated for the 'time-to-detection' measure.");
options.add("dtd",dtdSelected,"If this flag is specified, an impact file will be generated for the 'detected time-to-detection' measure.");

options.add("nfd",nfdSelected,"If this flag is specified, an impact file will be generated for the 'number-of-failed detections' measure.");

options.add("ec",ecSelected,"If this flag is specified, an impact file will be generated for the 'extent of contamination' measure.");
options.add("dec",decSelected,"If this flag is specified, an impact file will be generated for the 'detected extent of contamination' measure.");

#if TEVA_SPOT_LIMITED
options.add("pk",pkSelected,"If this parameter is specified, an impact file wll be generated for the 'population killed' measure.  The TAI input file is a threat_assess input that specifies parameters like dosage, response, lethality, etc Note: it is an intensive measure to compute. The number of TAI files must match the number of TSO files.");

options.add("dpk",dpkSelected,"If this parameter is specified, an impact file wll be generated for the 'detected population killed' measure.  The TAI input file is a threat_assess input that specifies parameters like dosage, response, lethality, etc Note: it is an intensive measure to compute. The number of TAI files must match the number of TSO files.");

options.add("pd",pdSelected,"If this parameter is specified, an impact file wll be generated for the 'population dosed' measure.  The TAI input file is a threat_assess input that specifies parameters like dosage, response, lethality, etc Note: it is an intensive measure to compute. The number of TAI files must match the number of TSO files.");

options.add("dpd",dpdSelected,"If this parameter is specified, an impact file wll be generated for the 'detected population dosed' measure.  The TAI input file is a threat_assess input that specifies parameters like dosage, response, lethality, etc Note: it is an intensive measure to compute. The number of TAI files must match the number of TSO files.");

options.add("pe",peSelected,"If this parameter is specified, an impact file wll be generated for the 'population exposed' measure.  The TAI input file is a threat_assess input that specifies parameters like dosage, response, lethality, etc Note: it is an intensive measure to compute. The number of TAI files must match the number of TSO files.");

options.add("dpe",dpeSelected,"If this parameter is specified, an impact file wll be generated for the 'detected population exposed' measure.  The TAI input file is a threat_assess input that specifies parameters like dosage, response, lethality, etc Note: it is an intensive measure to compute. The number of TAI files must match the number of TSO files.");
#endif
...
options.add("tsoPattern",tsoPattern,"This string specifies a regular expression for all input TSO files when the files are stored in a directory (e.g. when generated by TEVA)");

options.add_argument("output-prefix","The prefix used for all files generated by tso2Impact.");

options.add_argument("tso-directory-or-file","This argument indicates either a TSO file (generated by tevasim) or a directory name for TSO files (generated by TEVA).  If the later, then the filenames must be specified with the --tsoPattern option.");

options.add_argument("tai-directory-or-file","This argument indicates either a TAI file name.  There should be one TAI file for each TSO file");
...
utilib::OptionParser::args_t args = options.parse_args(argc,argv);
   ...
   if (options.version_option())
   {
      ...
      if (args.size() < 2)
      {
         std::cerr << "Please read the users' guide" << std::endl;
         // When the following line is present,  
         // tso2Impact on windows generates an error
  ...
  try 
    {
      ...
      process_arguments(argc, argv, 
			...
			nfdSelected, tdSelected, dtdSelected, ecSelected, decSelected,
			epanetInputFilename,
	...
	if(peSelected || pkSelected || pdSelected || dpeSelected || dpdSelected || dpkSelected) {
		...
		for(int i=0;i<nnodes;i++) {
		  ...
		  if(assessMem->node[i].info->nz[0] && pop > 0) {
		    Dose(ing->ingestionData[i],ing,&assessMem->node[i], assessMem->net,nsteps,assessMem->u,assessMem->dot,i,assessMem->doseBins);
