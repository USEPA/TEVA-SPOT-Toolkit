...
int main(int argc, char **argv)
{
  try 
	...
	//
       ...
       else if (pkSelected || peSelected) {
	 updateTheObjectives(nodes, links, net, tso, 
			  pkSelected, peSelected, 
	...
	curr_tso_index++;
      ...
      if(mcSelected==true)
	{
	  std::cout << "Impact outputs written to file=" << outputFilePrefix << "_" << MassConsumedObjective::ourImpactOutputFileSuffix << std::endl;
      ...
      if(vcSelected==true)
	{
	  std::cout << "Impact outputs written to file=" << outputFilePrefix << "_" << VolumeContaminatedWaterConsumedObjective::ourImpactOutputFileSuffix << std::endl;
      ...
      if(nfdSelected==true)
	{
	  std::cout << "Impact outputs written to file=" << outputFilePrefix << "_" << NumberFailedDetectionsObjective::ourImpactOutputFileSuffix << std::endl;
      ...
      if(tdSelected==true)
	{
	  std::cout << "Impact outputs written to file=" << outputFilePrefix << "_" << TimeToDetectionObjective::ourImpactOutputFileSuffix << std::endl;
      ...
      if(ecSelected==true)
	{
	  std::cout << "Impact outputs written to file=" << outputFilePrefix << "_" << ExtentOfContaminationObjective::ourImpactOutputFileSuffix << std::endl;
      ...
      if(pkSelected==true)
	{
	  std::cout << "Impact outputs written to file=" << outputFilePrefix << "_" << PopulationKilledObjective::ourImpactOutputFileSuffix << std::endl;
      ...
      if(peSelected==true)
	{
	  std::cout << "Impact outputs written to file=" << outputFilePrefix << "_" << PopulationExposedObjective::ourImpactOutputFileSuffix << std::endl;
