...
# read the open file "fworst" to do the mapping.  This should usually
...
def location_map(superlocs, fworst, fmap):
  ...
  # it was created from.
  #
  # Try the list of "worst impact" original locations first.
  ...
  # fworst is also sorted in increasing slID order.
  ...
  if len(slIDs.keys()) < len(superlocs):
    print "ERROR: Can't find all locations in worst file"
    sys.exit(0)
