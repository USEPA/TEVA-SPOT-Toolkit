...
stream << "CPU RunTime=         " << searchTime << " seconds" << endl;
stream << "CPU TotalTime=       " << (CPUSeconds() - startTime) << " seconds" << endl;
stream << "WallClock TotalTime= " << (WallClockSeconds() - startWall) << " seconds" << endl;
