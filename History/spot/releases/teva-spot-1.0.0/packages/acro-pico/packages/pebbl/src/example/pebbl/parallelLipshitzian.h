...
public:
  ...
  using serialLipshitzian<FunctionT>::incumbent;
  #endif
  ...
  void pack(utilib::PackBuffer& outBuffer)
	{
	outBuffer << Lipshitz_constant << incumbent;
  ...
  void unpack(utilib::UnPackBuffer& inBuffer)
	{
	inBuffer >> Lipshitz_constant >> incumbent;
	unsigned int len;
	inBuffer >> len;
  ...
  bool setup(int& argc,char**& argv)
    {
      ucout << "This function should not be called.\n";
      return false;
    }
