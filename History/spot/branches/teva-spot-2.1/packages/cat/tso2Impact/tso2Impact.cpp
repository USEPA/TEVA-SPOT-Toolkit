...
#if TEVA_SPOT_LIMITED
options.usage = "tso2Impact [options] <output-prefix> <tso-directory-or-files> <tai-directory-or-files>";
...
#else
options.usage = "tso2Impact [options] <output-prefix> <tso-directory-or-files>";
