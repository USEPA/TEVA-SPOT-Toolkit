...
#define EN_ENERGY       13
#define EN_LINKQUAL     14     /*Added 04/05/2004 Tom Taxon*/
...
EXTERN int   CALLTYPE ENgetnumdemands(int, int *);
EXTERN int   CALLTYPE ENgetbasedemand(int, int, float *);
EXTERN int   CALLTYPE ENgetdemandpattern(int, int, int *);
