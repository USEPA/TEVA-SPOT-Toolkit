...
#define MySetupVersion "2.4"
#define MyAppRevision "(r3944)"
...
DefaultDirName={code:GetDeSpacedName|{pf}\tevaspot}
...
Source: ../vpy/instlight.ini; DestDir: {app}/dist
Source: ../build/tevaspot_bin_win32.zip; DestDir: {app}/dist; Check: IsWin32; Flags: 32bit
Source: ../build/tevaspot_py_win32.zip; DestDir: {app}/dist
...
[Run]
Filename: {code:GetPythonPath}\python.exe; Parameters: {app}/dist/spot_install --release --config={app}/dist/instlight.ini --offline --zip={app}/dist/tevaspot_py_win32.zip --zip={app}/dist/tevaspot_bin_win32.zip --zip={app}/dist/tevaspot_acro.zip {app}; WorkingDir: {app}\..; Flags: 32bit; Check: IsWin32; StatusMsg: Installing TEVA-SPOT Toolkit... (32-bit executables)
Filename: {code:GetPythonPath}\python.exe; Parameters: {app}/dist/spot_install --release --config={app}/dist/instlight.ini --offline --zip={app}/dist/tevaspot_py_win32.zip --zip={app}/dist/tevaspot_bin_win64.zip --zip={app}/dist/tevaspot_acro.zip {app}; WorkingDir: {app}\..; Flags: 64bit; Check: IsWin64; StatusMsg: Installing TEVA-SPOT Toolkit... (64-bit executables)
