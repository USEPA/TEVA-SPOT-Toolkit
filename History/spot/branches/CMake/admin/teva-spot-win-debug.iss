...
Source: ../build/tevaspot_py_data_win64.zip; DestDir: {app}/dist
...
[Run]
Filename: {code:GetPythonPath}python.exe; Parameters: {app}/dist/spot_install --offline --zip={app}/dist/tevaspot_py_data_win64.zip --zip={app}/dist/tevaspot_bin_win32.zip --zip={app}/dist/tevaspot_acro.zip {app}; WorkingDir: {app}\..; Flags: 32bit; Check: IsWin32; StatusMsg: Installing TEVA-SPOT Toolkit... (32-bit executables)
Filename: {code:GetPythonPath}python.exe; Parameters: {app}/dist/spot_install --offline --zip={app}/dist/tevaspot_py_data_win64.zip --zip={app}/dist/tevaspot_bin_win64.zip --zip={app}/dist/tevaspot_acro.zip {app}; WorkingDir: {app}\..; Flags: 64bit; Check: IsWin64; StatusMsg: Installing TEVA-SPOT Toolkit... (64-bit executables)
