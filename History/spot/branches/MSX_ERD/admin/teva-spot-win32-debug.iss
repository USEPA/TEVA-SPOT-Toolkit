...
Source: ../../tevaspot_win32_debug.zip; DestDir: {app}/dist
...
[Run]
Filename: {code:GetPythonPath}python.exe; Parameters: {app}/dist/spot_install --zip={app}/dist/tevaspot_win32_debug.zip --zip={app}/dist/tevaspot_bin_win32.zip --zip={app}/dist/tevaspot_acro.zip {app}; WorkingDir: {app}\..
