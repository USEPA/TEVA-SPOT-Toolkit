...
# @sp:
sp --path=$bin --path=$pico --path=$mod --network=Net3 --objective=ec --ub=ns,5 --solver=pico 2>&1 > solver14.sp
# @:sp

mv Net3.sensors Net3_orig.sensors
echo "AA"
# @evalsensor:
evalsensor --nodemap=Net3.nodemap --sc-probabilities=Net3.imperfectsc --scs=Net3.imperfectjc Net3_orig.sensors Net3_ec.impact
# @:evalsensor
