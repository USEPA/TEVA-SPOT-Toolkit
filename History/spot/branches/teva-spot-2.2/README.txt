...
The TEVA-SPOT Toolkit User Manual provides a detailed description of the
command-line tools in the TEVA-SPOT Toolkit.  The examples used in 
this manual can be accessed in the C:\spot\examples\simple directory.


TEVA-SPOT Toolkit Bug Tracking
==============================

http://engcvs.uc.edu/cgi-bin/bugzilla/index.cgi
...
4. Bug Reports
   ...
   See the Bugzilla project page: http://engcvs.uc.edu/cgi-bin/bugzilla/index.cgi
