...
/**
 * A class to manipulate strings that contain a terminating null \000 at 
...
//
//
inline void CharString::write(ostream& os) const
{
if (size() == 0) return;
...
//
//
inline void CharString::read(istream& is)
{
  char buf[256];
  int ndx=0;
...
//
///
inline ostream& operator<<(ostream& os, const utilib::CharString& array)
{ array.write(os); return os; }

//============================================================================
//
//
///
inline istream& operator>>(istream& is, utilib::CharString& array)
{ array.read(is); return is; }

//============================================================================
//
//
///
inline utilib::PackBuffer& operator<<(utilib::PackBuffer& os, const utilib::CharString& array)
{ array.write(os); return os; }
...
//
///
inline utilib::UnPackBuffer& operator>>(utilib::UnPackBuffer& is, utilib::CharString& array)
{ array.read(is); return is; }
