...
///
/// An Ereal base class the conditionally defines an integer conversion
/// operator
///
template <class Type, bool real_flag>
class Ereal_base {
...
public:
  ...
  /// Converts the value of this Ereal to an integer
  virtual int as_int() const
	{ return 0; }

};

/// Specialization for non-realdata types
template <class Type>
class Ereal_base<Type,false> {
};
 ...
 */
template <class Type>
class Ereal : public PackObject, public Ereal_base<Type,is_real<Type>::value>
{
public:
...
template<class Type>
Type Ereal<Type>::positive_infinity_val = (Type) 1e307;


/// Numeric value used for negative infinity.
template<class Type>
Type Ereal<Type>::negative_infinity_val = (Type) -1e307;
...
{
return exp(static_cast<Type>(num));
}
