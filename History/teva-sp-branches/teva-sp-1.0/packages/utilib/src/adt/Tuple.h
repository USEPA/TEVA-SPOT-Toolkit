...
//
template <class T1>
inline ostream& operator<<(ostream& os, const utilib::Tuple1<T1>& obj)
{ obj.write(os); return os; }

template <class T1, class T2>
inline ostream& operator<<(ostream& os, const utilib::Tuple2<T1,T2>& obj)
{ obj.write(os); return os; }

template <class T1, class T2, class T3>
inline ostream& operator<<(ostream& os, const utilib::Tuple3<T1,T2,T3>& obj)
{ obj.write(os); return os; }

template <class T1, class T2, class T3, class T4>
inline ostream& operator<<(ostream& os, const utilib::Tuple4<T1,T2,T3,T4>& obj)
{ obj.write(os); return os; }

template <class T1, class T2, class T3, class T4, class T5>
inline ostream& operator<<(ostream& os, const utilib::Tuple5<T1,T2,T3,T4,T5>& obj)
{ obj.write(os); return os; }

template <class T1, class T2, class T3, class T4, class T5, class T6>
inline ostream& operator<<(ostream& os, const utilib::Tuple6<T1,T2,T3,T4,T5,T6>& obj)
{ obj.write(os); return os; }

template <class T1, class T2, class T3, class T4, class T5, class T6, class T7>
inline ostream& operator<<(ostream& os, const utilib::Tuple7<T1,T2,T3,T4,T5,T6,T7>& obj)
{ obj.write(os); return os; }
...
//
template <class T1>
inline utilib::PackBuffer& operator<<(utilib::PackBuffer& os, const utilib::Tuple1<T1>& obj)
{ obj.write(os); return os; }

template <class T1, class T2>
inline utilib::PackBuffer& operator<<(utilib::PackBuffer& os, const utilib::Tuple2<T1,T2>& obj)
{ obj.write(os); return os; }

template <class T1, class T2, class T3>
inline utilib::PackBuffer& operator<<(utilib::PackBuffer& os, const utilib::Tuple3<T1,T2,T3>& obj)
{ obj.write(os); return os; }

template <class T1, class T2, class T3, class T4>
inline utilib::PackBuffer& operator<<(utilib::PackBuffer& os, const utilib::Tuple4<T1,T2,T3,T4>& obj)
{ obj.write(os); return os; }

template <class T1, class T2, class T3, class T4, class T5>
inline utilib::PackBuffer& operator<<(utilib::PackBuffer& os, const utilib::Tuple5<T1,T2,T3,T4,T5>& obj)
{ obj.write(os); return os; }

template <class T1, class T2, class T3, class T4, class T5, class T6>
inline utilib::PackBuffer& operator<<(utilib::PackBuffer& os, const utilib::Tuple6<T1,T2,T3,T4,T5,T6>& obj)
{ obj.write(os); return os; }

template <class T1, class T2, class T3, class T4, class T5, class T6, class T7>
inline utilib::PackBuffer& operator<<(utilib::PackBuffer& os, const utilib::Tuple7<T1,T2,T3,T4,T5,T6,T7>& obj)
{ obj.write(os); return os; }
...
//
template <class T1>
inline istream& operator>>(istream& is, utilib::Tuple1<T1>& obj)
{ obj.read(is); return is; }

template <class T1, class T2>
inline istream& operator>>(istream& is, utilib::Tuple2<T1,T2>& obj)
{ obj.read(is); return is; }

template <class T1, class T2, class T3>
inline istream& operator>>(istream& is, utilib::Tuple3<T1,T2,T3>& obj)
{ obj.read(is); return is; }

template <class T1, class T2, class T3, class T4>
inline istream& operator>>(istream& is, utilib::Tuple4<T1,T2,T3,T4>& obj)
{ obj.read(is); return is; }

template <class T1, class T2, class T3, class T4, class T5>
inline istream& operator>>(istream& is, utilib::Tuple5<T1,T2,T3,T4,T5>& obj)
{ obj.read(is); return is; }

template <class T1, class T2, class T3, class T4, class T5, class T6>
inline istream& operator>>(istream& is, utilib::Tuple6<T1,T2,T3,T4,T5,T6>& obj)
{ obj.read(is); return is; }

template <class T1, class T2, class T3, class T4, class T5, class T6, class T7>
inline istream& operator>>(istream& is, utilib::Tuple7<T1,T2,T3,T4,T5,T6,T7>& obj)
{ obj.read(is); return is; }
...
//
template <class T1>
inline utilib::UnPackBuffer& operator>>(utilib::UnPackBuffer& is, utilib::Tuple1<T1>& obj)
{ obj.read(is); return is; }

template <class T1, class T2>
inline utilib::UnPackBuffer& operator>>(utilib::UnPackBuffer& is, utilib::Tuple2<T1,T2>& obj)
{ obj.read(is); return is; }

template <class T1, class T2, class T3>
inline utilib::UnPackBuffer& operator>>(utilib::UnPackBuffer& is, utilib::Tuple3<T1,T2,T3>& obj)
{ obj.read(is); return is; }

template <class T1, class T2, class T3, class T4>
inline utilib::UnPackBuffer& operator>>(utilib::UnPackBuffer& is, utilib::Tuple4<T1,T2,T3,T4>& obj)
{ obj.read(is); return is; }

template <class T1, class T2, class T3, class T4, class T5>
inline utilib::UnPackBuffer& operator>>(utilib::UnPackBuffer& is, utilib::Tuple5<T1,T2,T3,T4,T5>& obj)
{ obj.read(is); return is; }

template <class T1, class T2, class T3, class T4, class T5, class T6>
inline utilib::UnPackBuffer& operator>>(utilib::UnPackBuffer& is, utilib::Tuple6<T1,T2,T3,T4,T5,T6>& obj)
{ obj.read(is); return is; }

template <class T1, class T2, class T3, class T4, class T5, class T6, class T7>
inline utilib::UnPackBuffer& operator>>(utilib::UnPackBuffer& is, utilib::Tuple7<T1,T2,T3,T4,T5,T6,T7>& obj)
{ obj.read(is); return is; }
