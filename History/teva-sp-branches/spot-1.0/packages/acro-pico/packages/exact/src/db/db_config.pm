...
%db_config = (
   ...
   'zoltan' => {
	name => 'Zoltan',
   	dir => 'data/zoltan',
	maillist => 'schake@sandia.gov',
	update => 'cvs -Q -d /space/CVS-Zoltan update data/zoltan',
	checkout => 'cvs -Q -d /space/CVS-Zoltan checkout -d data/zoltan Zoltan_Tests/testdata',
	remove => 'cvs -d /space/CVS-Zoltan remove',
	commit => 'cvs -d /space/CVS-Zoltan commit -m "Files removed by db-daemon"'
	},
);
