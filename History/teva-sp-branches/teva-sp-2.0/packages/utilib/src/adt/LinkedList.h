...
/*
** TODO: What is the issue here?  namespace support?
*/
...
template <class _Tp, class _Alloc>
inline std::ostream& operator<<(std::ostream& os, const utilib::LinkedList<_Tp,_Alloc>& obj)
{
utilib::ListItem<_Tp>* curr = (obj.first == obj.last ? 0 : obj.first);
...
template <class _Tp, class _Alloc>
inline std::istream& operator>>(std::istream& is, utilib::LinkedList<_Tp,_Alloc>& obj)
{
int tmp;
is >> tmp;
for (int i=0; i<tmp; i++) {
