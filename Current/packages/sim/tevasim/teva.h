...
extern "C" {
#endif
void run_flushsim(const char* tsgfname, const char* tsifname, const char* erdfname, const char* epanetinpfname, const char* epanetoutfname, const char* decfname, const char *msxfname, const char *msxspecies);
