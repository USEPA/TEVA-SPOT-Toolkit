...
#ifndef tevasp_ModulePopulationExposedObjective_h
#define tevasp_ModulePopulationExposedObjective_h
...
class ModulePopulationExposedObjective : public PopulationExposedObjective
{
public:
   ModulePopulationExposedObjective(PMem m) : PopulationExposedObjective(m) 
   {
   }

   ModulePopulationExposedObjective(const ModulePopulationExposedObjective& other):
			PopulationExposedObjective(other)
   {
   }

   ModulePopulationExposedObjective& operator=(
			const ModulePopulationExposedObjective &other)
   {
	if (this!=&other)
		PopulationExposedObjective::operator=(other);
	return *this;
   }
